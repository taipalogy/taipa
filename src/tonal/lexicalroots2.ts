...
export const list_of_lexical_roots = [
    ...
    'liangx', 'liangz', 'liap', 'liapp', 'liet', 'liauy', 'liauw', 'liaux',
    ...
    'qiannx', 'qiannz', 'qiap', 'kiet', 'kiett', 'qiau', 'qiauy', 'qiaux',
    'qiauz', 'qek', 'qekk', 'qim', 'qimy', 'qimw', 'qimz', 'qin', 'qiny',
    'qinw', 'qinz', 'qeng', 'qengy', 'qengw', 'qengx', 'qengz', 'qinn', 'qinnw',
    'qinnx', 'kiurw', 'qiurx', 'qiurz', 'qiurh', 'qiok', 'qiokk', 'qiong',
    ...
    'voannz', 'voat', 'voatt', 'voe', 'voey', 'voew', 'voex', 'poez', 'poeh',
