import { SetOfNasalFinals, NeutralFinalH, FirstTonalF, NeutralFinalHH, ThirdFifthTonalsWX, EuphonicFinalsBGJKLPS, EuphonicFinalsBBGGJJKKLLPPSS } from './version2'
...
export const sm_bgjklps = function(euphonicFinalBGJKLPS: string) {
    ...
    if(efs.beginWith(euphonicFinalBGJKLPS))
        return true;
...
export const sm_bbggjjkkllppss = function(euphonicFinalBBGGJJKKLLPPSS: string) {
    ...
    if(efs.beginWith(euphonicFinalBBGGJJKKLLPPSS))
        return true;
