...
import { eighthToFirst, combiningRules, finalOfPhrasalVerbParticle } from '../tonal/collections';
...
import { TonalPhrasalAssimilationMetaplasm, TonalPhrasalInflectionMetaplasm } from '../phraseme';
...
export class ConjugateTwoToProceeding extends TonalPhrasalInflectionMetaplasm {
    applyTwoParticles(
