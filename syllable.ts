...
class FromSSToZS extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterZS());
    }
}

class FromSSToXX extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterXX());
    }
}

class FromSSToXXX extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterXXX());
    }
}
...
class FromWToY extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        if(b.splitAtLastIndex(new AlphabetFactory().createLowerLetterW())) {
            return b.pushLetter(new AlphabetFactory().createLowerLetterY());
        }
    }
}
...
class FromZSToW extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        if(b.splitAtLastIndex(new AlphabetFactory().createLowerLetterZS())) {
            return b.pushLetter(new AlphabetFactory().createLowerLetterW());
        }
...
class FromKToKK extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterK());
    }
}

class FromPToPP extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterP());
    }
}

class FromTToTT extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterT());
    }
}

class FromBToBX extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterX());
    }
}

class FromBToBB extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterB());
    }
}
...
class FromDToDD extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterD());
    }
}
...
class FromGToGG extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterG());
    }
}
...
class FromFToFF extends Rule {
    getSandhiForm(b: ToneSandhiSyllable) {
        return b.pushLetter(new AlphabetFactory().createLowerLetterF());
    }
}
...
class RulesOfSandhiTone {
    ...
    getSandhiForms(b: ToneSandhiSyllable): Array<ToneSandhiSyllable> {
        ...
        for(let k in this.rules) {
            if(b.lastLetter.literal.search(this.rules[k])) {
                arr = this.rules[k];
            } else {
                arr = this.rules['ss'];
            }
...
export class Syllables {
    ...
    populateSandhiFormTo(ss: Array<ToneSandhiSyllable>) {
        let baseforms: Array<ToneSandhiSyllable>;
        for(let k in ss) {
            baseforms.push(ss[k]);
        }
    ...
    match(letters: Array<AlphabeticLetter>) {
        ...
        for(let i = 0; i < letters.length; i++) {
            ...
            if(i-beginOfSyllable == 0) {
                ...
                let arr = this.list.filter(s => s[0] === letters[i].literal);
                for(let k in arr) {
...
export class AllomorphemicSyllablesOfBaseForm extends SyllablesNew {
    //list: Array<string>;
    list_of_rime_of_ziang_accent: Array<string>;
    list_of_rime_of_zuanx_accent: Array<string>;
    list_of_syllable_of_zuanx_accent: Array<string>;
    ...
    match(letters: Array<AlphabeticLetter>) {
        if(this.isSandhiForm()) {
            ;
        }
    }

    isSandhiForm(): Boolean {
